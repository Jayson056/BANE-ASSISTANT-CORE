...
SERVICE_SRC="$SCRIPT_DIR/bane.service"
SUDOERS_SRC="$SCRIPT_DIR/bane_sudoers"
AUTOSTART_SRC="$SCRIPT_DIR/antigravity.desktop"

SERVICE_DEST="/etc/systemd/system/bane.service"
SUDOERS_DEST="/etc/sudoers.d/bane"
...
echo "Enabling bane service..."
systemctl enable bane

echo "Starting bane service..."
systemctl start bane

echo "✅ BANE Installed Successfully!"
echo ""
echo "📋 Post-Install:"
echo "  - BANE backend: systemctl status bane"
