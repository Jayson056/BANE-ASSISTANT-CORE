...
text = "Hey! I noticed that voice message coming through, but unfortunately, the system hit a network timeout while attempting to download the audio file. 📶\n\nCould you try resending it or just drop a quick text instead? I'm ready to keep testing here in the group chat! ✅"
