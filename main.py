...
def start_dashboard():
    ...
    try:
        dashboard_script = "/home/user/BANE_CORE/scripts/launch_dashboard.sh"
...
if __name__ == "__main__":
    ...
    subprocess.Popen(
        ["/home/user/BANE_CORE/.venv/bin/python3", "/home/user/BANE_CORE/core/network_watchdog.py"],
        stdout=subprocess.DEVNULL,
        stderr=subprocess.DEVNULL,
        start_new_session=True
    )
    ...
    try:
        ...
        with open(messenger_log, "a") as mlog:
            subprocess.Popen(
                [
                    "/home/user/BANE_CORE/.venv/bin/gunicorn",
                    "--bind", "0.0.0.0:8082",
                    "--workers", "2",
                    "--threads", "4",
                    "--timeout", "120",
                ...
                stdout=mlog,
                stderr=mlog,
                cwd="/home/user/BANE_CORE",
                env={**os.environ, "PYTHONPATH": "/home/user/BANE_CORE"},
                start_new_session=True
            )
