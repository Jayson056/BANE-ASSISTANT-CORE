...
if __name__ == "__main__":
    file_path = "/home/user/BANE_CORE/storage/users/9eb397f15a125a6d/cor_text.txt"
    try:
    ...
    if not schedule:
        ...
        # Save to file (Text)
        out_dir = "/home/user/BANE_CORE_Workspaces/USER-DATA/9eb397f15a125a6d/School/School Calendar"
        import os
        import json
